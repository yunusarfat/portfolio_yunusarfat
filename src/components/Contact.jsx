...
const Contact = () => {
  ...
  return (
    <section id="contact" className=" text-white min-h-screen bg-gradient-to-b from-gray-800 via-gray-900 to-gray-800 py-24 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          <div>
            <h3 className="text-2xl font-semibold mb-4 text-navy-dark">Contact Information</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-navy-dark">Email</h4>
                  <a href="mailto:mdarfatyunus.gmail.com" className="text-gray-600 hover:text-blue-600 transition-colors">
                    mdarfatyunus.gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  >
                    linkedin.com/in/yunus-md-arfat
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-navy-dark">GitHub</h4>
                  <a 
